...
jQuery(document).ready(function($) {
  ...
  $(".clearit input, .clearit textarea").cleardefault();
    ...
    $('.page-template-page-gift-php img').load(function(){
        $('#heart-box').fadeIn();
    });

    $('.lid-one').on('click touchstart', function() {
      $(this).fadeOut(10,function(){
            $('.lid-two').addClass('start');
            $('.lid-two').delay(80).animate({
                bottom:['70%','swing'],
                left: ['3px','swing'],
                width: ['96%','easeOutBounce']},
                600,
                function(){
                    $(this).css('z-index', '0');
                    //$('.box-base, #heart-box ul').animate({scale: 1.005},600);
                    $(this).animate({
                        bottom:['-3.5%','swing'],
                        left: ['-11%','swing'],
                        rotate: '5deg',
 ...
 /*   $('.lid-close').on('click touchstart', function() {

            $('.lid-two').delay(80).animate({
                bottom:['-3%','swing'],
                left: ['-10%','swing'],
                width: ['93%','easeOutBounce'],
                rotate: '5deg'
                    },
                600,
                function(){
