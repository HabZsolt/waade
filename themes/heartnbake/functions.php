...
//Add UID to heart gift

add_filter("gform_field_value_heartbox-uid", "populate_uid");
...
function enqueue_gf_readonly() {
  wp_register_script( 'gf-readonly', get_template_directory_uri() . '/library/js/gravity-forms-readonly.js', array( 'jquery' ), '', false );
  wp_enqueue_script( 'gf-readonly' );
}
 
add_action( 'wp_enqueue_scripts', 'enqueue_gf_readonly' );
