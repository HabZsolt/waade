...
function additional_libraries() {
  ...
  if (!is_admin()) {
    wp_register_script( 'main', get_template_directory_uri() . '/library/js/min/main-min.js', array( 'jquery' ), '', false );
    wp_enqueue_script( 'main' );
    
    if (is_page_template('page-start.php')) {
      wp_register_script( 'carousel', get_template_directory_uri() . '/library/js/min/carousel-min.js', array( 'jquery' ), '', false );
      wp_enqueue_script( 'carousel' );
    }

    if (is_page_template('page-projects.php')) {
      wp_register_script( 'projects', get_template_directory_uri() . '/library/js/min/projects-min.js', array( 'jquery' ), '', false );
