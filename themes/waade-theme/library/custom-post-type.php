...
function add_custom_post_types() { 
	...
	register_post_type( 'project', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			...
			'description' => __( 'This is the Project post type', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			...
			'rewrite'	=> array( 'slug' => 'projekt', 'with_front' => true ), /* you can specify its url slug */
